...
class KgdataController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        $grid->quickSearch('probj', 'break_nm', 'cause_nm', 'action_nm');    
        $grid->fixColumns(2, 0);
    ...
    // {
    //     $show = new Show(Kgdata::findOrFail($id));
