...
class pbta5 extends StepForm
{
    ...
    public function handle(Request $request)
    {
        ...
        $distri = ""; // 적용분포
        $fmode = "";
        //if(array_key_exists('고장모드선택', $ALL['pbta5'])) {
        //    $fmode = implode(',', array_filter($ALL['pbta5']['고장모드선택']));
        //}
        $smode = "";
        //if($ALL['pbta1']['모드선택'] == 'C') {
        //    $smode = $key1_cd;
