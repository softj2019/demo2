...
class KgtagController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = '생산설비기능위치(Tag사용)';
    ...
    protected function grid()
    {
        ...
        $grid->quickSearch('key3_cd', 'key3_nm', 'key4_cd', 'key4_nm', 'key5_cd', 'key5_nm', 'key6_cd', 'key6_nm', 'FL_TAG');    
        $grid->fixColumns(2, 0);
    ...
    // {
    //     $show = new Show(Kgtag::findOrFail($id));
